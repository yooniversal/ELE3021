...
main(int argc, char *argv[])
{
  ...
  16:	e8 07 03 00 00       	call   322 <my_syscall>
	printf(1, "Return value : 0x%x\n", ret_val);
  1b:	83 c4 0c             	add    $0xc,%esp
  1e:	50                   	push   %eax
  1f:	68 b3 07 00 00       	push   $0x7b3
  24:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb c8 07 00 00       	mov    $0x7c8,%ebx
        while(*s != 0){
