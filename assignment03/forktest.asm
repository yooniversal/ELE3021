...
0000046a <thread_create>:
SYSCALL(thread_create)
 46a:	b8 1b 00 00 00       	mov    $0x1b,%eax
 46f:	cd 40                	int    $0x40
 471:	c3                   	ret    

00000472 <thread_exit>:
SYSCALL(thread_exit)
