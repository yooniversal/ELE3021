...
main(int argc, char *argv[])
{
  ...
  25:	89 c6                	mov    %eax,%esi
	  yield();
  27:	e8 56 03 00 00       	call   382 <yield>

	  if(pid < 0)
  2c:	85 f6                	test   %esi,%esi
  2e:	78 39                	js     69 <main+0x69>
	  {
		  printf(1, "fork failed\n");
		  exit();
	  }
	  if(pid > 0)
  30:	75 16                	jne    48 <main+0x48>
		wait();			
		printf(1, "Parent\n");
  	  }
	  if(pid == 0)
  ...
  45:	8d 76 00             	lea    0x0(%esi),%esi
		wait();			
  48:	e8 8d 02 00 00       	call   2da <wait>
		printf(1, "Parent\n");
  4d:	83 ec 08             	sub    $0x8,%esp
  50:	68 05 08 00 00       	push   $0x805
  55:	6a 01                	push   $0x1
  57:	e8 44 04 00 00       	call   4a0 <printf>
  for(i=0; i<10; i++)
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	83 eb 01             	sub    $0x1,%ebx
  62:	75 bc                	jne    20 <main+0x20>
	  }
  }

  exit();
  64:	e8 69 02 00 00       	call   2d2 <exit>
		  printf(1, "fork failed\n");
  69:	52                   	push   %edx
  6a:	52                   	push   %edx
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 437:	f7 f1                	div    %ecx
 439:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 14 08 00 00       	mov    $0x814,%ebx
        while(*s != 0){
 ...
 671:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 c8 0a 00 00    	cmp    %eax,0xac8
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 7c7:	0a 00 00 
 7ca:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 7d1:	0a 00 00 
    base.s.size = 0;
 7d4:	b8 cc 0a 00 00       	mov    $0xacc,%eax
 7d9:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 7e0:	00 00 00 
