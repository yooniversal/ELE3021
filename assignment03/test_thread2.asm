...
main(int argc, char *argv[])
{
  ...
  int start = 0;
    ...
    if (pid == 0){
      ...
      55:	ff 35 ec 23 00 00    	pushl  0x23ec
      ...
      74:	6a 04                	push   $0x4
      76:	57                   	push   %edi
      77:	ff 35 e8 23 00 00    	pushl  0x23e8
      ...
      9c:	ff 35 e8 23 00 00    	pushl  0x23e8
      a2:	e8 53 13 00 00       	call   13fa <close>
    }
    printf(1,"%d. %s finish\n", i, testname[i]);
      a7:	ff 34 9d 60 23 00 00 	pushl  0x2360(,%ebx,4)
      ae:	53                   	push   %ebx
  for (i = start; i <= end; i++){
      af:	83 c3 01             	add    $0x1,%ebx
    printf(1,"%d. %s finish\n", i, testname[i]);
      b2:	68 94 1a 00 00       	push   $0x1a94
      b7:	6a 01                	push   $0x1
  ...
  for (i = start; i <= end; i++){
    ...
    printf(1,"%d. %s start\n", i, testname[i]);
      cf:	ff 34 9d 60 23 00 00 	pushl  0x2360(,%ebx,4)
      d6:	53                   	push   %ebx
      d7:	68 60 1a 00 00       	push   $0x1a60
      dc:	6a 01                	push   $0x1
      de:	e8 bd 14 00 00       	call   15a0 <printf>
    if (pipe(gpipe) < 0){
      e3:	c7 04 24 e8 23 00 00 	movl   $0x23e8,(%esp)
      ...
      fa:	53                   	push   %ebx
      fb:	53                   	push   %ebx
      fc:	68 6e 1a 00 00       	push   $0x1a6e
     101:	6a 01                	push   $0x1
     103:	e8 98 14 00 00       	call   15a0 <printf>
      exit();
  ...
  exit();
     13e:	e8 8f 12 00 00       	call   13d2 <exit>
        printf(1,"%d. %s panic\n", i, testname[i]);
     143:	ff 34 9d 60 23 00 00 	pushl  0x2360(,%ebx,4)
     14a:	53                   	push   %ebx
     14b:	68 86 1a 00 00       	push   $0x1a86
     150:	6a 01                	push   $0x1
     152:	e8 49 14 00 00       	call   15a0 <printf>
        exit();
     157:	e8 76 12 00 00       	call   13d2 <exit>
      printf(1,"fork panic\n");
     15c:	51                   	push   %ecx
     15d:	51                   	push   %ecx
     15e:	68 7a 1a 00 00       	push   $0x1a7a
     163:	6a 01                	push   $0x1
     165:	e8 36 14 00 00       	call   15a0 <printf>
      exit();
     16a:	e8 63 12 00 00       	call   13d2 <exit>
      close(gpipe[0]);
     16f:	83 ec 0c             	sub    $0xc,%esp
     172:	ff 35 e8 23 00 00    	pushl  0x23e8
     178:	e8 7d 12 00 00       	call   13fa <close>
      ret = testfunc[i]();
     17d:	ff 14 9d a0 23 00 00 	call   *0x23a0(,%ebx,4)
     ...
     18d:	6a 04                	push   $0x4
     18f:	50                   	push   %eax
     190:	ff 35 ec 23 00 00    	pushl  0x23ec
     196:	e8 57 12 00 00       	call   13f2 <write>
      close(gpipe[1]);
     19b:	5a                   	pop    %edx
     19c:	ff 35 ec 23 00 00    	pushl  0x23ec
     ...
     1d1:	ba 80 96 98 00       	mov    $0x989680,%edx
{
  ...
  for (i = 0; i < 10000000; i++){
    tmp = gcnt;
     1e0:	a1 e4 23 00 00       	mov    0x23e4,%eax
    tmp++;
  ...
  for (i = 0; i < 10000000; i++){
    ...
    gcnt = tmp;
     1f0:	a3 e4 23 00 00       	mov    %eax,0x23e4
  for (i = 0; i < 10000000; i++){
     ...
     21b:	31 db                	xor    %ebx,%ebx
{
  ...
  for (i = 0; i < 100000000; i++){
     247:	83 c3 01             	add    $0x1,%ebx
      printf(1, "%d", tid);
     24a:	56                   	push   %esi
     24b:	68 f8 18 00 00       	push   $0x18f8
     250:	6a 01                	push   $0x1
     252:	e8 49 13 00 00       	call   15a0 <printf>
...
jointhreadmain(void *arg)
{
  ...
  printf(1, "thread_exit...\n");
     290:	58                   	pop    %eax
     291:	5a                   	pop    %edx
     292:	68 fb 18 00 00       	push   $0x18fb
     297:	6a 01                	push   $0x1
     299:	e8 02 13 00 00       	call   15a0 <printf>
...
000002f0 <exittest2>:
{
  ...
  for (i = 0; i < NUM_THREAD; i++){
     ...
     323:	68 0b 19 00 00       	push   $0x190b
     328:	6a 01                	push   $0x1
     32a:	e8 71 12 00 00       	call   15a0 <printf>
}
     ...
     348:	bb 01 00 00 00       	mov    $0x1,%ebx
{
  ...
  printf(1, "thread_join!!!\n");
     383:	58                   	pop    %eax
     384:	5a                   	pop    %edx
     385:	68 23 19 00 00       	push   $0x1923
     38a:	6a 01                	push   $0x1
     38c:	e8 0f 12 00 00       	call   15a0 <printf>
  ...
  printf(1,"\n");
     ...
     3bf:	68 31 19 00 00       	push   $0x1931
     3c4:	6a 01                	push   $0x1
     3c6:	e8 d5 11 00 00       	call   15a0 <printf>
  return 0;
     ...
     3e3:	68 0b 19 00 00       	push   $0x190b
     3e8:	6a 01                	push   $0x1
     3ea:	e8 b1 11 00 00       	call   15a0 <printf>
      return -1;
     ...
     403:	68 33 19 00 00       	push   $0x1933
     408:	6a 01                	push   $0x1
     ...
     426:	8d 45 ac             	lea    -0x54(%ebp),%eax
{
  ...
  if ((pid = fork()) < 0){
    ...
    gcnt = 0;
     4eb:	c7 05 e4 23 00 00 00 	movl   $0x0,0x23e4
     4f2:	00 00 00 
  ...
  if (gcnt != 0)
     55e:	a1 e4 23 00 00       	mov    0x23e4,%eax
     563:	85 c0                	test   %eax,%eax
     565:	74 38                	je     59f <pipetest+0x17f>
    printf(1,"panic at validation in pipetest : %d\n", gcnt);
     567:	a1 e4 23 00 00       	mov    0x23e4,%eax
     56c:	83 ec 04             	sub    $0x4,%esp
     56f:	50                   	push   %eax
     570:	68 30 1b 00 00       	push   $0x1b30
     575:	6a 01                	push   $0x1
     577:	e8 24 10 00 00       	call   15a0 <printf>
     ...
     58b:	bf ff ff ff ff       	mov    $0xffffffff,%edi
        printf(1, "panic at thread_create\n");
     590:	68 0b 19 00 00       	push   $0x190b
     595:	6a 01                	push   $0x1
     ...
     5b3:	bf ff ff ff ff       	mov    $0xffffffff,%edi
        printf(1, "panic at thread_join\n");
     5b8:	68 33 19 00 00       	push   $0x1933
     5bd:	6a 01                	push   $0x1
     5bf:	e8 dc 0f 00 00       	call   15a0 <printf>
        return -1;
    ...
    printf(1, "panic at pipe in pipetest\n");
     5d9:	68 49 19 00 00       	push   $0x1949
     5de:	6a 01                	push   $0x1
     5e0:	e8 bb 0f 00 00       	call   15a0 <printf>
    return -1;
     ...
     5ed:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      printf(1, "panic at fork in pipetest\n");
     5f2:	68 64 19 00 00       	push   $0x1964
     5f7:	6a 01                	push   $0x1
     5f9:	e8 a2 0f 00 00       	call   15a0 <printf>
      return -1;
    ...
    printf(1, "panic at wait in pipetest\n");
     608:	68 7f 19 00 00       	push   $0x197f
     60d:	6a 01                	push   $0x1
     60f:	e8 8c 0f 00 00       	call   15a0 <printf>
    return -1;
...
00000620 <execthreadmain>:
{
  ...
  char *args[3] = {"echo", "echo is executed!", 0}; 
     628:	c7 45 ec 9a 19 00 00 	movl   $0x199a,-0x14(%ebp)
     62f:	c7 45 f0 9f 19 00 00 	movl   $0x199f,-0x10(%ebp)
  ...
  exec("echo", args);
     ...
     646:	5a                   	pop    %edx
     647:	50                   	push   %eax
     648:	68 9a 19 00 00       	push   $0x199a
     64d:	e8 b8 0d 00 00       	call   140a <exec>
  printf(1, "panic at execthreadmain\n");
     652:	59                   	pop    %ecx
     653:	58                   	pop    %eax
     654:	68 b1 19 00 00       	push   $0x19b1
     659:	6a 01                	push   $0x1
     65b:	e8 40 0f 00 00       	call   15a0 <printf>
  exit();
     ...
     696:	8d 7d e0             	lea    -0x20(%ebp),%edi
{
  ...
  int type = ((int*)arg)[0];
     ...
     6c4:	f0 01 05 e4 23 00 00 	lock add %eax,0x23e4
  for (i = -5; i <= 5; i++){
...
stridethreadmain(void *arg)
{
  ...
  while(*flag){
    ...
    while(*flag == 1){
     ...
     747:	f0 83 05 e4 23 00 00 	lock addl $0x1,0x23e4
     74e:	01 
...
stridetest(void)
{
  ...
  gcnt = 0;
     779:	c7 05 e4 23 00 00 00 	movl   $0x0,0x23e4
     780:	00 00 00 
  flag = 2;
     ...
     7b6:	8d 7d b8             	lea    -0x48(%ebp),%edi
{
  ...
  if (pid == 0){
    ...
    printf(1, " 2% : %d\n", gcnt);
     82d:	a1 e4 23 00 00       	mov    0x23e4,%eax
  if (pid == 0){
    ...
    printf(1, "10% : %d\n", gcnt);
     ...
     83d:	50                   	push   %eax
     83e:	68 ef 19 00 00       	push   $0x19ef
     843:	6a 01                	push   $0x1
     845:	e8 56 0d 00 00       	call   15a0 <printf>
    if (wait() == -1){
  ...
  return 0;
    ...
    set_cpu_share(10);
     ...
     883:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      printf(1, "panic at thread_create\n");
     888:	68 0b 19 00 00       	push   $0x190b
     88d:	6a 01                	push   $0x1
     88f:	e8 0c 0d 00 00       	call   15a0 <printf>
      return -1;
     ...
     8ab:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      printf(1, "panic at thread_join\n");
     8b0:	68 33 19 00 00       	push   $0x1933
     8b5:	6a 01                	push   $0x1
     8b7:	e8 e4 0c 00 00       	call   15a0 <printf>
      return -1;
    ...
    printf(1, "panic at fork in forktest\n");
     8c9:	56                   	push   %esi
     8ca:	56                   	push   %esi
     8cb:	68 ca 19 00 00       	push   $0x19ca
     8d0:	6a 01                	push   $0x1
     8d2:	e8 c9 0c 00 00       	call   15a0 <printf>
    exit();
     8d7:	e8 f6 0a 00 00       	call   13d2 <exit>
    printf(1, " 2% : %d\n", gcnt);
     8dc:	52                   	push   %edx
     8dd:	50                   	push   %eax
     8de:	68 e5 19 00 00       	push   $0x19e5
     8e3:	6a 01                	push   $0x1
     8e5:	e8 b6 0c 00 00       	call   15a0 <printf>
    exit();
     8ea:	e8 e3 0a 00 00       	call   13d2 <exit>
      printf(1, "panic at wait in forktest\n");
     8ef:	50                   	push   %eax
     8f0:	50                   	push   %eax
     8f1:	68 f9 19 00 00       	push   $0x19f9
     8f6:	6a 01                	push   $0x1
     8f8:	e8 a3 0c 00 00       	call   15a0 <printf>
      exit();
...
00000910 <exitthreadmain>:
{
  ...
  thread_exit(0);
     ...
     93b:	68 14 1a 00 00       	push   $0x1a14
     940:	6a 01                	push   $0x1
     942:	e8 59 0c 00 00       	call   15a0 <printf>
...
00000960 <forkthreadmain>:
{
  ...
  if ((pid = fork()) == -1){
    ...
    printf(1, "parent\n");
     ...
     977:	68 2c 1a 00 00       	push   $0x1a2c
     97c:	6a 01                	push   $0x1
     97e:	e8 1d 0c 00 00       	call   15a0 <printf>
    if (wait() == -1){
  ...
  thread_exit(0);
    ...
    printf(1, "panic at fork in forktest\n");
     99e:	51                   	push   %ecx
     99f:	51                   	push   %ecx
     9a0:	68 ca 19 00 00       	push   $0x19ca
     9a5:	6a 01                	push   $0x1
     9a7:	e8 f4 0b 00 00       	call   15a0 <printf>
    exit();
     9ac:	e8 21 0a 00 00       	call   13d2 <exit>
      printf(1, "panic at wait in forktest\n");
     9b1:	50                   	push   %eax
     9b2:	50                   	push   %eax
     9b3:	68 f9 19 00 00       	push   $0x19f9
     9b8:	6a 01                	push   $0x1
     9ba:	e8 e1 0b 00 00       	call   15a0 <printf>
      exit();
     9bf:	e8 0e 0a 00 00       	call   13d2 <exit>
    printf(1, "child\n");
     9c4:	52                   	push   %edx
     9c5:	52                   	push   %edx
     9c6:	68 25 1a 00 00       	push   $0x1a25
     9cb:	6a 01                	push   $0x1
     9cd:	e8 ce 0b 00 00       	call   15a0 <printf>
    exit();
...
000009e0 <exittest1>:
{
  ...
  return 0;
     ...
     a38:	68 0b 19 00 00       	push   $0x190b
     a3d:	6a 01                	push   $0x1
     a3f:	e8 5c 0b 00 00       	call   15a0 <printf>
     ...
     a68:	bb 01 00 00 00       	mov    $0x1,%ebx
{
  ...
  printf(1, "thread_join!!!\n");
     ...
     a99:	68 23 19 00 00       	push   $0x1923
     a9e:	6a 01                	push   $0x1
     aa0:	e8 fb 0a 00 00       	call   15a0 <printf>
  ...
  printf(1,"\n");
     ...
     ad7:	68 31 19 00 00       	push   $0x1931
     adc:	6a 01                	push   $0x1
     ade:	e8 bd 0a 00 00       	call   15a0 <printf>
  return 0;
     ...
     af3:	68 0b 19 00 00       	push   $0x190b
     af8:	6a 01                	push   $0x1
     afa:	e8 a1 0a 00 00       	call   15a0 <printf>
      return -1;
     ...
     b13:	68 33 19 00 00       	push   $0x1933
     b18:	6a 01                	push   $0x1
     b1a:	e8 81 0a 00 00       	call   15a0 <printf>
...
00000b30 <stresstest>:
{
  ...
  for (n = 1; n <= nstress; n++){
    ...
    if (n % 1000 == 0)
     ...
     bb8:	50                   	push   %eax
     bb9:	68 f5 19 00 00       	push   $0x19f5
     bbe:	6a 01                	push   $0x1
     bc0:	e8 db 09 00 00       	call   15a0 <printf>
     bc5:	83 c4 10             	add    $0x10,%esp
     bc8:	e9 76 ff ff ff       	jmp    b43 <stresstest+0x13>
     bcd:	8d 76 00             	lea    0x0(%esi),%esi
        printf(1, "panic at thread_create\n");
     bd0:	83 ec 08             	sub    $0x8,%esp
     bd3:	68 0b 19 00 00       	push   $0x190b
     bd8:	6a 01                	push   $0x1
     bda:	e8 c1 09 00 00       	call   15a0 <printf>
        return -1;
     ...
     bf3:	68 33 19 00 00       	push   $0x1933
     bf8:	6a 01                	push   $0x1
     bfa:	e8 a1 09 00 00       	call   15a0 <printf>
        return -1;
  ...
  printf(1, "\n");
     ...
     c15:	68 31 19 00 00       	push   $0x1931
     c1a:	6a 01                	push   $0x1
     c1c:	e8 7f 09 00 00       	call   15a0 <printf>
     ...
     c36:	31 db                	xor    %ebx,%ebx
{
  ...
  for (i = 0; i < NUM_THREAD; i++){
     ...
     c93:	68 33 19 00 00       	push   $0x1933
     c98:	6a 01                	push   $0x1
     c9a:	e8 01 09 00 00       	call   15a0 <printf>
      return -1;
     ...
     cb3:	68 0b 19 00 00       	push   $0x190b
     cb8:	6a 01                	push   $0x1
     cba:	e8 e1 08 00 00       	call   15a0 <printf>
...
00000cd0 <sbrkthreadmain>:
{
  ...
  thread_exit(0);
     ...
     d42:	68 34 1a 00 00       	push   $0x1a34
     d47:	6a 01                	push   $0x1
     d49:	e8 52 08 00 00       	call   15a0 <printf>
      exit();
     ...
     d65:	31 db                	xor    %ebx,%ebx
{
  ...
  return 0;
     ...
     db8:	68 0b 19 00 00       	push   $0x190b
     dbd:	6a 01                	push   $0x1
     dbf:	e8 dc 07 00 00       	call   15a0 <printf>
...
00000dd0 <forktest>:
{
  ...
  for (i = 0; i < NUM_THREAD; i++){
     ...
     e3b:	68 0b 19 00 00       	push   $0x190b
     e40:	6a 01                	push   $0x1
     e42:	e8 59 07 00 00       	call   15a0 <printf>
      return -1;
     ...
     e63:	68 33 19 00 00       	push   $0x1933
     e68:	6a 01                	push   $0x1
     e6a:	e8 31 07 00 00       	call   15a0 <printf>
     ...
     e86:	31 db                	xor    %ebx,%ebx
{
  ...
  for (i = 0; i < NUM_THREAD; i++){
     ...
     eeb:	68 0b 19 00 00       	push   $0x190b
     ef0:	6a 01                	push   $0x1
     ef2:	e8 a9 06 00 00       	call   15a0 <printf>
      return -1;
     ...
     f13:	68 33 19 00 00       	push   $0x1933
     f18:	6a 01                	push   $0x1
     f1a:	e8 81 06 00 00       	call   15a0 <printf>
     ...
     f35:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1,"\n");
     ...
     f97:	68 31 19 00 00       	push   $0x1931
     f9c:	6a 01                	push   $0x1
     f9e:	e8 fd 05 00 00       	call   15a0 <printf>
  return 0;
     ...
     fb3:	68 0b 19 00 00       	push   $0x190b
     fb8:	6a 01                	push   $0x1
     fba:	e8 e1 05 00 00       	call   15a0 <printf>
      return -1;
     ...
     fd3:	68 33 19 00 00       	push   $0x1933
     fd8:	6a 01                	push   $0x1
     fda:	e8 c1 05 00 00       	call   15a0 <printf>
...
00000ff0 <exectest>:
{
  ...
  printf(1, "panic at exectest\n");
    ...
    104f:	68 4d 1a 00 00       	push   $0x1a4d
    1054:	6a 01                	push   $0x1
    1056:	e8 45 05 00 00       	call   15a0 <printf>
  return 0;
    ...
    1073:	68 0b 19 00 00       	push   $0x190b
    1078:	6a 01                	push   $0x1
    107a:	e8 21 05 00 00       	call   15a0 <printf>
      return -1;
    ...
    1093:	68 33 19 00 00       	push   $0x1933
    1098:	6a 01                	push   $0x1
    109a:	e8 01 05 00 00       	call   15a0 <printf>
    ...
    10b5:	31 db                	xor    %ebx,%ebx
{
  ...
  gcnt = 0;
    10ba:	c7 05 e4 23 00 00 00 	movl   $0x0,0x23e4
    10c1:	00 00 00 
  ...
  printf(1,"%d\n", gcnt);
    1111:	8b 15 e4 23 00 00    	mov    0x23e4,%edx
    1117:	83 ec 04             	sub    $0x4,%esp
    111a:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    111d:	52                   	push   %edx
    111e:	68 f5 19 00 00       	push   $0x19f5
    1123:	6a 01                	push   $0x1
    1125:	e8 76 04 00 00       	call   15a0 <printf>
  return 0;
    ...
    1143:	68 0b 19 00 00       	push   $0x190b
    1148:	6a 01                	push   $0x1
    114a:	e8 51 04 00 00       	call   15a0 <printf>
      return -1;
    ...
    1163:	68 33 19 00 00       	push   $0x1933
    1168:	6a 01                	push   $0x1
    116a:	e8 31 04 00 00       	call   15a0 <printf>
...
000014b2 <xem_init>:
SYSCALL(xem_init)
    14b2:	b8 1e 00 00 00       	mov    $0x1e,%eax
    14b7:	cd 40                	int    $0x40
    14b9:	c3                   	ret    

000014ba <xem_wait>:
SYSCALL(xem_wait)
    14ba:	b8 1f 00 00 00       	mov    $0x1f,%eax
    14bf:	cd 40                	int    $0x40
    14c1:	c3                   	ret    

000014c2 <xem_unlock>:
SYSCALL(xem_unlock)
    14c2:	b8 20 00 00 00       	mov    $0x20,%eax
    14c7:	cd 40                	int    $0x40
    14c9:	c3                   	ret    

000014ca <rwlock_init>:
SYSCALL(rwlock_init)
    14ca:	b8 21 00 00 00       	mov    $0x21,%eax
    14cf:	cd 40                	int    $0x40
    14d1:	c3                   	ret    

000014d2 <rwlock_acquire_readlock>:
SYSCALL(rwlock_acquire_readlock)
    14d2:	b8 22 00 00 00       	mov    $0x22,%eax
    14d7:	cd 40                	int    $0x40
    14d9:	c3                   	ret    

000014da <rwlock_release_readlock>:
SYSCALL(rwlock_release_readlock)
    14da:	b8 23 00 00 00       	mov    $0x23,%eax
    14df:	cd 40                	int    $0x40
    14e1:	c3                   	ret    

000014e2 <rwlock_acquire_writelock>:
SYSCALL(rwlock_acquire_writelock)
    14e2:	b8 24 00 00 00       	mov    $0x24,%eax
    14e7:	cd 40                	int    $0x40
    14e9:	c3                   	ret    

000014ea <rwlock_release_writelock>:
SYSCALL(rwlock_release_writelock)
    14ea:	b8 25 00 00 00       	mov    $0x25,%eax
    14ef:	cd 40                	int    $0x40
    14f1:	c3                   	ret    
    14f2:	66 90                	xchg   %ax,%ax
    14f4:	66 90                	xchg   %ax,%ax
    ...
    1509:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    1537:	f7 f1                	div    %ecx
    1539:	0f b6 92 60 1b 00 00 	movzbl 0x1b60(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15e0:	e8 0d fe ff ff       	call   13f2 <write>
  ...
  write(fd, &c, 1);
    ...
    1641:	e8 ac fd ff ff       	call   13f2 <write>
  ...
  write(fd, &c, 1);
    165a:	e8 93 fd ff ff       	call   13f2 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    16f3:	57                   	push   %edi
    16f4:	53                   	push   %ebx
    16f5:	e8 f8 fc ff ff       	call   13f2 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1747:	e8 a6 fc ff ff       	call   13f2 <write>
        ap++;
    ...
    1754:	e9 8f fe ff ff       	jmp    15e8 <printf+0x48>
          s = "(null)";
    1759:	bb 58 1b 00 00       	mov    $0x1b58,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1771:	a1 d8 23 00 00       	mov    0x23d8,%eax
{
  ...
  freep = p;
    17af:	a3 d8 23 00 00       	mov    %eax,0x23d8
}
    17b4:	5b                   	pop    %ebx
    17b5:	5e                   	pop    %esi
    17b6:	5f                   	pop    %edi
    ...
    17c6:	72 ce                	jb     1796 <free+0x26>
{
  ...
  freep = p;
    17ea:	a3 d8 23 00 00       	mov    %eax,0x23d8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    180c:	8b 15 d8 23 00 00    	mov    0x23d8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    187b:	8b 15 d8 23 00 00    	mov    0x23d8,%edx
    ...
    18a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    18a7:	89 15 d8 23 00 00    	mov    %edx,0x23d8
}
    ...
    base.s.ptr = freep = prevp = &base;
    18c0:	c7 05 d8 23 00 00 dc 	movl   $0x23dc,0x23d8
    18c7:	23 00 00 
    18ca:	c7 05 dc 23 00 00 dc 	movl   $0x23dc,0x23dc
    18d1:	23 00 00 
    base.s.size = 0;
    18d4:	b8 dc 23 00 00       	mov    $0x23dc,%eax
    18d9:	c7 05 e0 23 00 00 00 	movl   $0x0,0x23e0
    18e0:	00 00 00 
